...
public class ManagerControllerTest {
	...
	@Test
	public void testAllProcessedLoansIsServiceMethodCalled() throws Exception {
	...
	@Test
	public void testRejectLoanIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		RejectDto rejectDto = MasterData.getRejectDto();
	...
	@Test
	public void testSanctionLoanIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		SanctionDto sanctionDto = MasterData.getSanctionDto();
		SanctionOutputDto sanctionOutputDto = MasterData.getSanctionOutputDto();
	...
	@Test
	public void testAllFinalizedLoans() throws Exception {
		List<LoanOutputDto> loanOutputDtos = MasterData.getLoanOutputDtoListForManager();
	...
	@Test
	public void testAllFinalizedLoansIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		List<LoanOutputDto> loanOutputDtos = MasterData.getLoanOutputDtoListForManager();
